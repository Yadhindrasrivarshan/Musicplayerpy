...
def CreateWidgets():
    ...
    trackLabel.grid(row=0, column=0, pady=7, padx=7)
    ...
    volUpButton = Button(root, width=20, text="VOLUME UP", command=VolumeUp, highlightbackground="BROWN")
...
def Play():
    ...
    audioStatus = Label(root, width=20, text="SONG IS PLAYING :)", bg="RED")
